...
rg = {
  rg1 = {
    rg_name    = "lz-prod-rg-app-westus2"
    location   = "westus2"
...
vnet = {
  vnet1 = {
    name                = "lz-prod-vnet-westus2"
    resource_group_name = "lz-prod-rg-app-westus2"
    location            = "westus2"
...
subnet = {
  frontend = {
    ...
    virtual_network_name = "lz-prod-vnet-westus2"
    resource_group_name  = "lz-prod-rg-app-westus2"
...
nic = {
  frontend = {
    ...
    vnet_name           = "lz-prod-vnet-westus2"
